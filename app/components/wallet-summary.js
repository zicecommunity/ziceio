    ...
    <OutsideWrapper>
      ...
      <Wrapper>
        <TotalContainer>
          ...
          />
          <USDValue
            value={`USD $${formatNumber({ value: total * zcePrice })}`}
        ...
        <DetailMainContainer>
          <DetailContainer>
            ...
            isBold
              size='16px'
            />
            <USDValue value={`USD $${formatNumber({ value: shielded * zcePrice })}`} />
          </DetailContainer>
          <DetailContainer>
            ...
            isBold
              size='16px'
            />
            <USDValue value={`USD $${formatNumber({ value: transparent * zcePrice })}`} />
          </DetailContainer>
          <DetailContainer>
            ...
            isBold
              size='16px'
            />
            <USDValue value={`USD $${formatNumber({ value: unconfirmed * zcePrice })}`} />
          </DetailContainer>
        </DetailMainContainer>
      </Wrapper>
    </OutsideWrapper>
